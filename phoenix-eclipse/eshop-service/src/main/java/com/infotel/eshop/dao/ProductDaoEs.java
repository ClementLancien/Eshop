...
public class ProductDaoEs implements ProductDao {
	...
	@Override
	public Map<String, Object> findByCriteria(String keyword, int familyId, String tag, boolean randomize) throws EShopException {
...
//								 .filter(familyFilter);
		...
		try {
			...
			resultat.put("sizeCollection", (int) resp.getHits().getTotalHits().value);
